...
function sizeContent() {
    var newHeight = $(".trailer-container").height() - $("header").height() - $("#footer").height() + "px";
    $(".trailer-container").css("height", newHeight);
}

// This is for fullscreen Vimeo video
